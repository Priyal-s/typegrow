...
<body>
    ...
    <body>
        ...
        <body>
            ...
            <h1 class="text-center mb-4">LinkedIn Post Preview</h1>

            <div class="mb-3 text-center">
                <label for="postTopic" class="form-label fs-5">Easily preview your LinkedIn post before publishing. <br>Just type
                    or copy-paste your text below to see the preview.</label>
            </div>
            ...
            <div class="container editor-container">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div id="editor"></div>
                        <button id="copyText" class="btn btn-dark mt-3">Copy text</button>
                    </div>
                    <div class="col-md-6">
                        <!-- Post Preview Section -->
                        <h5 class="small text-start">preview-box</h5>
 ...
 This line will appear below the see more..." readonly="" fdprocessedid="6fj2z" style="height: 138px;"></textarea>
        ...
        <div class="instructions-container  ">
            <div class="instructions-header">
                <h2 class="fw-bold fs-3">How to preview your LinkedIn post before publishing?
                </h2>
            </div>
            ...
            <div class="step mb-4">
                ...
                <div class="step-content">
                    <h4 class="mb-3">Copy & Paste Your Content
                    </h4>
                    <p class="">First, copy the text from your post and then enter it into the input box provided above.
                    </p>
                </div>
            </div>
            ...
            <div class="step mb-4">
                ...
                <div class="step-content">
                    <h4 class="mb-3">Instant Preview
                    </h4>
                    <p class="">As soon as you paste your text, you will be able to see the real-time post preview on the right-hand side, displaying exactly how your content will appear on LinkedIn.
                    </p>
                </div>
            </div>
            ...
            <div class="step mb-4">
                ...
                <div class="step-content">
                    <h4 class="mb-3">Preview in Different Modes
                    </h4>
                    <p class="">Toggle between device views to understand your post's appearance on mobile and desktop. Look for where LinkedIn will truncate "see more" to ensure your content is visible.
                    </p>
                </div>
            </div>
            ...
            <div class="step mb-4">
                ...
                <div class="step-content">
                    <h4 class="mb-3">Publish on LinkedIn
                    </h4>
                    <p class="">Once you have reviewed your content, then head over to LinkedIn and share your post.
                    </p>
                </div>
            </div>
        </div>
